...
public class Carinho extends JApplet implements Runnable { 
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(sheetcarinho, dstX0, dstY0, dstX1, dstY1, srcX0, srcY0, srcX1, srcY1, null);
    }
  
    private Image sheetcarinho;
    private int counter = 0; 
 
    private static final int FRAME_WIDTH = 504; 
    private static final int FRAME_HEIGHT = 246;
