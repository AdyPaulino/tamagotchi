...
public class Seringa extends JApplet implements Runnable
{ 
    public void init()
    {
    ...
    public void render(Graphics g)
    {
        ...
        g.drawImage(sheetseringa, 		//aqui desenha a imagem na tela
    ...
    private Image sheetseringa;
    private int counter = 0; 
 
    private static final int FRAME_WIDTH = 91; //largura em pixels da figura
    private static final int FRAME_HEIGHT = 500;//altura em pixels da figura
    ...
    private static final int DISPLAY_HEIGHT = 612;
}
