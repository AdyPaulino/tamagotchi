//frame � a figura
//display � a tela
//delay tempo q espera

import java.awt.*;
import java.awt.image.*;
import javax.swing.*;

public class CriancaSono extends JApplet implements Runnable
{ 
    public void init()
    {
        ...
        sheetcriancasono = getImage(getCodeBase(), "sheetcriancafeliz.gif");
    ...
    public void render(Graphics g)
    {
        ...
        int dstX0 = (DISPLAY_WIDTH-FRAME_WIDTH)-100;
        int dstY0 = (DISPLAY_HEIGHT-FRAME_HEIGHT)-50;
        int dstX1 = dstX0+FRAME_WIDTH;
        int dstY1 = dstY0+FRAME_HEIGHT;
 
        g.drawImage(sheetcriancasono, 		//aqui desenha a imagem na tela
    ...
    private Image sheetcriancasono;
    private int counter = 0; 
 
    private static final int FRAME_WIDTH = 274; //largura em pixels da figura
    private static final int FRAME_HEIGHT = 214;//altura em pixels da figura
