...
public class Cenoura extends JApplet implements Runnable
{ 
    public void init()
    {
    ...
    public void render(Graphics g)
    {
        ...
        g.drawImage(sheetcenoura, 		//aqui desenha a imagem na tela
    ...
    private Image sheetcenoura;
    private int counter = 0; 
 
    private static final int FRAME_WIDTH = 150; //largura em pixels da figura  //280
    private static final int FRAME_HEIGHT = 400;//altura em pixels da figura
