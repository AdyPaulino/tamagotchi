...
public class AdultoFeliz extends JApplet implements Runnable
{ 
    public void init()
    {
        ...
        sheetadultofeliz = getImage(getCodeBase(), "sheetadultofome.gif");
    ...
    private Image sheetadultofeliz;
    private int counter = 0; 
 
    private static final int FRAME_WIDTH = 412;
    private static final int FRAME_HEIGHT = 292;
