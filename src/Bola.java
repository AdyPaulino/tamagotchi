...
public class Bola extends JApplet implements Runnable
{ 
    public void init()
    {
    ...
    public void render(Graphics g)
    {
        ...
        g.drawImage(sheetbola, 		//aqui desenha a imagem na tela
    ...
    private Image sheetbola;
    private int counter = 0; 
 
    private static final int FRAME_WIDTH = 186; //largura em pixels da figura
    private static final int FRAME_HEIGHT = 468;//altura em pixels da figura
