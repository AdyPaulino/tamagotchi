...
public class NotasMusicais extends JApplet implements Runnable { 
    ...
    public void init() {
        ...
        sheetnotasmusicais = getImage(getCodeBase(), "sheetnotasmusicais.gif");
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(sheetnotasmusicais, dstX0, dstY0, dstX1, dstY1, srcX0, srcY0, srcX1, srcY1, null);
    }
  
    private Image sheetnotasmusicais;
