...
public class Sanduiche extends JApplet implements Runnable { 
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(sheetsanduiche, dstX0, dstY0, dstX1, dstY1, srcX0, srcY0, srcX1, srcY1, null);
    }
  
    private Image sheetsanduiche;
    private int counter = 0; 
 
    private static final int FRAME_WIDTH = 430; 
    private static final int FRAME_HEIGHT = 332;
